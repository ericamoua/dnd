{
    ...
    document.getElementById("strength").addEventListener("input", function (event) {
        ...
        //findmodifier() is being called and used here
        let strengthModifier = findModifier(strength);

        document.getElementById("strengthModifier").textContent = strengthModifier;
    });

    document.getElementById("constitution").addEventListener("input", function (event) {
        var constitution = document.getElementById("constitution").value;
        let constitutionModifier = findModifier(constitution)
        document.getElementById("constitutionModifier").textContent = constitutionModifier;
    });
